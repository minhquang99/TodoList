                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input runat="server" type="text" style="display:none;" class="form-control" id="idCVNV" />
                                <select class="form-control" id="tenCongViec">
                                    <asp:PlaceHolder ID="dsCongViec" runat="server"></asp:PlaceHolder>
                                </select>                                
                            </div>
                            <div class="form-group">
